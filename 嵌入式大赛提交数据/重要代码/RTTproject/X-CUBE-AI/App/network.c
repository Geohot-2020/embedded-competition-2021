...
#define AI_NETWORK_MODEL_SIGNATURE     "543584bcd74182bb621f797ee74678d3"
...
#define AI_TOOLS_DATE_TIME   "Mon Sep 27 20:44:09 2021"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 420, 32, 1, 1), AI_STRIDE_INIT(4, 4, 1680, 53760, 53760),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_2_bias_array.data = AI_PTR(weights + 56128);
    dense_2_bias_array.data_start = AI_PTR(weights + 56128);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 56000);
    dense_2_weights_array.data_start = AI_PTR(weights + 56000);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 55936);
    dense_1_bias_array.data_start = AI_PTR(weights + 55936);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 53888);
    dense_1_weights_array.data_start = AI_PTR(weights + 53888);
    dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_bias_array.data = AI_PTR(weights + 53760);
    dense_bias_array.data_start = AI_PTR(weights + 53760);
