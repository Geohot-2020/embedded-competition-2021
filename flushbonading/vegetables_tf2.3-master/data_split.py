...
if __name__ == '__main__':
    src_data_folder = "D:/ali_download/flushbonading/vegetables_tf2.3-master/data"   # todo 修改你的原始数据集路径
    target_data_folder = "D:/ali_download/flushbonading/vegetables_tf2.3-master/new_data"  # todo 修改为你要存放的路径
